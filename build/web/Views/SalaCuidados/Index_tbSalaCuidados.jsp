<%-- 
    Document   : Index_tbSalaCuidados
    Created on : 09-01-2019, 04:56:44 PM
    Author     : keyci
--%>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Agregar Paciente Internado</h5>
        ...
        <div class="modal-body">
          <form class="form-horizontal" role="form">
            <div class="form-group">
                                  <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Identidad:</label>
                                 <div class="col-sm-9">
      ...
      <div class="modal-body2">
        <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                  <input type="text" id="form-field-2" class="col-xs-12 col-sm-8" />
...
<button type="button" class="btn btn-danger">Eliminar</button>
          ...
          <div class="row">
          <div class="col-md-11">
            <h3 class="header smaller lighter blue">Listado de Pacientes Hospitalizados
              <div style="float:Right;" margin="bottom">
                    <a type="button"  class="btn btn-info" type="button" id="btnNuevo">
                    ...
                    <tr >
                      ...
                      <td >
                        <div>
                          ...
                          <a class="btn btn-minier btn-warning text-center" id="" href="Hospital_BI/Views/SalaCuidados/Edit_SalaCuidados.jsp">
