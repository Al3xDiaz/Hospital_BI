<%-- 
    Document   : CreateInventarioFarmacia
    Created on : 09-01-2019, 09:33:57 PM
    Author     : keyci
--%>
						...
						<div class="col-sm-12">
							...
							<div class="widget-box">
								<div class="widget-header">
									<h4>Crear Inventario Farmacia</h4>
										...
										<form class="form-horizontal" role="form">
											...
											<div class="row">
												...
												<div class="col-xs-6 form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Medicamento ID </label>

													<div class="col-sm-6">
														<select >
															<option value="">&nbsp;</option>
															<option value="AL">Acetaminofén</option>
														</select>
													</div>
												</div>
											...
											<div class="row">
												...
												<div class="col-xs-6 form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Farmacia ID </label>

													<div class="col-sm-6">
														<select >
															<option value="">&nbsp;</option>
															<option value="AL">Farmacia SPS</option>
