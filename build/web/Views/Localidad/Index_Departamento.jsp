...
<%@include file="../../Shared/LayoutTop.jsp" %>
        <div class="row">
          <div class="col-md-11">
            <h3 class="header smaller lighter blue">Listado de Departamentos</h3>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
          <form class="form-horizontal" role="form">
            <div class="form-group">
                                 ...
                                 <div class="col-sm-9">
                                      <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" disable value="1"/>
                                  </div>
                              </div>
                        <div class="space-4"></div>
      <div class="modal-body2">
        <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                  <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" value="Córtes"/>
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form">
          <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Id:</label>
                               <div class="col-sm-9">
                                    <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" disable value=""/>
                                </div>
                            </div>
                      <div class="space-4"></div>
    <div class="modal-body2">
      <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Departamento: </label>
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" value=""/>
                                <span class="help-inline col-xs-12 col-sm-7">
                                    <span class="middle"></span>
                                </span>
                            </div>
