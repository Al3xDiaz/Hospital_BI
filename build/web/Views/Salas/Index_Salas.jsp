<%-- 
    Document   : Index_Salas
    Created on : 09-01-2019, 05:09:04 PM
    Author     : keyci
--%>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" role="form">
              <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> ID Sala:</label>
                <div class="col-sm-9">
              ...
              <div class="modal-body2">
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> ID Bloque Hospital: </label>
                  <div class="col-sm-9">
                    <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" />
              ...
              <div class="modal-body2">
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> ID Tipo Sala: </label>
                  <div class="col-sm-9">
                    <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" />
                    <span class="help-inline col-xs-12 col-sm-7">
                      <span class="middle"></span>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-info" data-dismiss="modal">Agregar</button>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="modal-body">
            <form class="form-horizontal" role="form">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" placeholder="A23" />
                </div>
              </div>
              <div class="space-4"></div>
              <div class="modal-body2">
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Estado:</label>
                  <div class="col-sm-9">
                    <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" placeholder="1" />
                    <span class="help-inline col-xs-12 col-sm-7">
                      <span class="middle"></span>
                    </span>
                  </div>
    ...
    <div class="modal fade" id="ModalEliminar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="row">
          <div class="col-md-11">
            <h3 class="header smaller lighter blue">Listado de Sala</h3>
            <a class="btn btn-primary pull-right" id="btnNuevo">Agregar</a>
            <br><br>
