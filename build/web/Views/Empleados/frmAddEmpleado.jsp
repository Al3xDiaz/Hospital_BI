											...
											<form class="form-horizontal" role="form">
												<div class="row">
													...
													<div class="col-xs-6 form-group">
														...
														<div class="col-sm-10">
															<input type="text" id="form-field-1" class="col-xs-10 col-sm-10" />
														</div>
													</div>
													...
													<div class="col-xs-6 form-group">
														...
														<div class="col-sm-9">
															<div class="input-group">
																<input class="form-control date-picker" id="id-date-picker-1" type="text" value="1990-01-01"data-date-format="yyyy-mm-dd" />
