<%-- 
    Document   : IndexConsultas
    Created on : 09-01-2019, 04:20:26 PM
    Author     : keyci
--%>
...
<button type="button" class="btn btn-danger" data-dismiss="modal" >Eliminar</button>
        ...
        <div class="row">
          <div class="col-xs-11">
            <h3 class="header smaller lighter blue">Consulta General
              <div style="float:Right;" margin="bottom">
                  <button class="btn btn-info" type="button" id="btnNuevo">
