<%-- 
    Document   : Index_ServiciosMedicos
    Created on : 09-01-2019, 05:12:50 PM
    Author     : keyci
--%>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h5 class="modal-title" id="exampleModalLabel">Modal de Agregar</h5>

          </div>
          <div class="modal-body">
            <form class="form-horizontal" role="form">
              <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> ID Servicios:</label>
                <div class="col-sm-9">
              ...
              <div class="modal-body2">
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> ID Catalagos: </label>
                  <div class="col-sm-9">
                    <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" />
              ...
              <div class="modal-body2">
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> ID Salas: </label>
                  <div class="col-sm-9">
                    <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" />
                    <span class="help-inline col-xs-12 col-sm-7">
                      <span class="middle"></span>
              ...
              <div class="modal-body2">
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> ID Pacientes: </label>
                  <div class="col-sm-9">
                    <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" />
                    <span class="help-inline col-xs-12 col-sm-7">
                      <span class="middle"></span>
              ...
              <div class="modal-body2">
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Estados: </label>
                  <div class="col-sm-9">
                    <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" />
                    <span class="help-inline col-xs-12 col-sm-7">
                      <span class="middle"></span>
              ...
              <div class="modal-body2">
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Fecha Facturas: </label>
                  <div class="col-sm-9">
                    <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" />
                    <span class="help-inline col-xs-12 col-sm-7">
                      <span class="middle"></span>
              ...
              <div class="modal-body2">
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Fecha Programadas: </label>
                  <div class="col-sm-9">
                    <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" />
                    <span class="help-inline col-xs-12 col-sm-7">
                      <span class="middle"></span>
          ...
          <div class="modal-footer">
            ...
            <a href="ServiciosMedicos.html">
              <button type="button" class="btn btn-primary" data-dismiss="modal">Agregar</button></a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h5 class="modal-title" id="exampleModalLabel">Modal de Editar</h5>
          ...
          <div class="modal-body">
            <form class="form-horizontal" role="form">
              ...
              <div class="modal-body2">
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Fecha Programada: </label>
                  <div class="col-sm-9">
                    <input type="text" id="form-field-1" class="col-xs-12 col-sm-8" />
                    <span class="help-inline col-xs-12 col-sm-7">
                      <span class="middle"></span>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <div class="row">
          <div class="col-md-11">
            <h3 class="header smaller lighter blue">Servicios Medico pendientes
              <a id="btnNuevo" class="btn btn-primary pull-right">Agregar</a><br /><br />
            </h3>
              ...
              <div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid">
                  ...
                  <thead>
                    <tr >
                      ...
                      <!-- <th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 62px;" aria-label="Status: activate to sort column ascending"> -->
                      <!-- Estado -->
                      <!-- </th> -->
                      <th >Acciones</th>
                    </tr>
