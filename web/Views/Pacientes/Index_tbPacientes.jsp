<%-- 
    Document   : Index_tbPacientes
    Created on : 09-01-2019, 04:28:55 PM
    Author     : keyci
--%>
...
<button type="button" class="btn btn-danger " data-dismiss="modal">Eliminar</button>
    ...
    <div class="row">
          <div class="col-md-11">
            <h3 class="header smaller lighter blue">Listado Pacientes Registrados
              <div style="float:Right;" margin="bottom">
                  <a type="button" href="Hospital_BI/Views/Pacientes/Create_Paciente.jsp" class="btn btn-info" type="button" id="btnNuevo">
                    ...
                    <tr >
                      ...
                      <td >
                        <div >
                          ...
                          <a class="btn btn-minier btn-warning text-center" id="btnEditar" href="Hospital_BI/Views/Pacientes/Update_Paciente.jsp">
